...
namespace ImageCommentsExtension_2022{
    internal class ImagePasteCommandTarget : CommandTargetBase<VSConstants.VSStd97CmdID>
    {
        ...
        public ImagePasteCommandTarget(IVsTextView adapter, IWpfTextView textView, string fileName)
            : base(adapter, textView, VSConstants.VSStd97CmdID.Paste)
        {
            _fileName = fileName;
            _variableExpander = new VariableExpander(textView);
        }
        ...
        protected override bool Execute(VSConstants.VSStd97CmdID commandId, uint nCmdexecopt, IntPtr pvaIn, IntPtr pvaOut)
        {
            ...
            try
            {
                ...
                existingFile = _variableExpander.replacer(existingFile);

                //UpdateTextBuffer(existingFile, _fileName);
                UpdateTextBuffer(existingFile);
            }
            catch (Exception ex)
            {
                //Logger.Log(ex);
