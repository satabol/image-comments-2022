...
namespace ImageCommentsExtension_2022
{
    ...
    internal static class ImageCommentParser
    {
		...
		//private static Regex _htmlImageCommentRegex;
		//private static Regex _htmlIndentRegex;
        ...
        static ImageCommentParser()
        {
            ...
            //const string htmlIndent = @"\<\!--\s+";
            //_htmlIndentRegex = new Regex(htmlIndent, RegexOptions.Compiled);
            //const string htmlCommentPattern = @"\<\!--.*-->";
            //_htmlImageCommentRegex = new Regex(htmlCommentPattern + xmlImageTagPattern, RegexOptions.Compiled);
        ...
        public static int Match(string contentTypeName, string lineText, out string matchedText)
        {
            ...
            switch (contentTypeName)
            {
                ...
                case "JSON":
                case "css":
                case "TypeScript":  // Very Funny - No JavaScript!!! Set 'Code' to see more in debug ))) No in documentation: https://docs.microsoft.com/ru-ru/visualstudio/extensibility/language-service-and-editor-extension-points?view=vs-2017
                ...
                case "Python":
                    ...
                    break;
                //case "Html":
                //    commentMatch = _htmlImageCommentRegex.Match(lineText);
                //    indentMatch = _htmlIndentRegex.Match(lineText);
                //    break;
